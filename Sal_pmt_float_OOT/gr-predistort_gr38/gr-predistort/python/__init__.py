...
'''
This is the GNU Radio PREDISTORT module. Place your Python package
...
# import swig generated symbols into the predistort namespace
try:
    # this might fail if the module is python-only
    from .predistort_swig import *
